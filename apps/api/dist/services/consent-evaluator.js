...
export class ConsentEvaluator {
    gracePeriodMinutes;
    constructor(gracePeriodMinutes = 0) {
     ...
     */
    async evaluateConsent(clientId, scopeType, scopeId, purpose) {
        try {
     ...
     */
    static createWithCaching(gracePeriodMinutes = 0) {
...
//# sourceMappingURL=consent-evaluator.js.map