...
export class BaseContextBuilder {
     ...
     */
    async buildBaseContext(userId, additionalContext) {
     ...
     */
    async buildReferralContext(userId, referralId, action, additionalContext) {
        const baseContext = await this.buildBaseContext(userId, additionalContext);
     ...
     */
    async buildReportContext(userId, reportType, action, additionalContext) {
        const baseContext = await this.buildBaseContext(userId, additionalContext);
     ...
     * - Program sharing
     */
    async getClientSpecificContext(clientId, userId, action) {
     ...
     */
    async getNoteSpecificContext(noteId, userId, action) {
        // TODO: Replace with actual database queries
        // Mock note lookup
        const mockNote = {
            id: noteId,
     ...
     */
    async getReferralSpecificContext(referralId, userId, action) {
        // TODO: Replace with actual database queries
     ...
     */
    async getReportSpecificContext(reportType, userId, action) {
        // TODO: Replace with actual database queries
     ...
     */
    async evaluateConsent(clientId, userId, action) {
     ...
     */
    async checkAssignment(clientId, userId) {
 ...
 */
export function createLegacyContextBuilder(resourceType) {
    const builder = new BaseContextBuilder();
    return async (req, resourceId) => {
        if (!req.user) {
        ...
        const additionalContext = {
            ...
            purpose: req.headers['x-purpose-of-use'] || 'care'
        };
        switch (resourceType) {
            case 'client':
...
//# sourceMappingURL=base-context-builder.js.map