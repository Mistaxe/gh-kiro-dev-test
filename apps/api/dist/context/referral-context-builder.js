...
export class ReferralContextBuilder extends BaseContextBuilder {
     ...
     */
    async getReferralInfo(referralId) {
     ...
     * Detect PHI content in referral
     */
    async detectPHIContent(referralId) {
     ...
     */
    async getReferralContent(referralId) {
        // TODO: Replace with actual database query
     ...
     */
    async getVisibilityContext(referralId, userId) {
        const referralInfo = await this.getReferralInfo(referralId);
        ...
        const in_network = userOrgInfo.network_ids.some(nid => targetLocationInfo.network_ids.includes(nid));
     ...
     */
    async getUserOrganizationalInfo(userId) {
        // TODO: Replace with actual database query
        // SELECT DISTINCT 
     ...
     */
    async getLocationOrganizationalInfo(locationId) {
        // TODO: Replace with actual database query
        // SELECT 
        //   sl.org_id,
        //   array_agg(DISTINCT o.network_id) as network_ids
     ...
     */
    async getReferralOrganizationalContext(referralId, userId) {
        const visibilityContext = await this.getVisibilityContext(referralId, userId);
        return {
     ...
     */
    async checkReferralConsent(referralId, userId) {
        const referralInfo = await this.getReferralInfo(referralId);
 ...
 */
export function createReferralContextBuilder() {
    return new ReferralContextBuilder();
}
//# sourceMappingURL=referral-context-builder.js.map