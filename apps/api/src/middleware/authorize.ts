...
import { AuthorizationContext, AuthorizationDecision } from '@app/shared'
import { AuthSubject, AuthObject, LegacyContextBuilder } from '../types/auth.js'

// For backward compatibility, create a type alias
type AuthDecision = AuthorizationDecision

// Extend Fastify types for authorization
...
export function authorize(contextBuilder?: LegacyContextBuilder) {
